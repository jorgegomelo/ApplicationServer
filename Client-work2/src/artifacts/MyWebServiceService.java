 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/WS-work2/MyWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://ws/", "MyWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS-work2/MyWebService?wsdl");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://ws/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "MyWebServicePort"), MyWebService.class, features);
    }
